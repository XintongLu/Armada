...
<body>
	...
	<div class="container">
		<div class="col-sm-12 text-center" style="margin-top:5%">
			<form  method="post" action="register_process.php" role="form" class="form-horizontal">
				<h2>Register</h2><br/>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="password" name="psw" class="form-control" placeholder="6-16 characters"/>
					</div>
				</div>
				<div class="form-group">
					<label for="confirm" class="col-sm-3 col-sm-offset-2 control-label">confirm:</label> 
					<div class="col-sm-2">
						<input type="password" name="cfm" class="form-control" placeholder="confirm password" />
					</div>
				</div>
				<div class="form-group">
					<label for="firstname" class="col-sm-3 col-sm-offset-2 control-label">firstname:</label> 
					<div class="col-sm-2">
						<input type="text" name="fn" class="form-control" placeholder="enter your firstname" />
					</div>
				</div>
				<div class="form-group">
					<label for="lastname" class="col-sm-3 col-sm-offset-2 control-label">lastname:</label> 
					<div class="col-sm-2">
						<input type="text" name="ln" class="form-control" placeholder="enter your lastname" />
					</div>
				</div>
				<div class="form-group">
					<label for="lastname" class="col-sm-3 col-sm-offset-2 control-label">gender:</label> 
					<div class="col-sm-2">
